...
class ListenPage extends GetView<ListenController> {
  ...
  _buildAppBar() {
    return AppBar(
      leading: Obx(() => controller.showPlay.value
          ? Icon(Icons.menu)
          : IconButton(
              icon: Icon(Icons.arrow_back_outlined),
              onPressed: () {
                controller.showPlay.toggle();
              },
            )),
      elevation: 0,
      ...
      actions: [
        Obx((() => Offstage(
              ...
              offstage: !controller.showPlay.value,
            )))
      ],
    );
  }
  ...
  Widget _buildPlayUi() {
    ...
    return Obx(() => Visibility(
          ...
          replacement: SingleChildScrollView(child: _buildSearchList()),
          visible: controller.showPlay.value,
        ));
  }
      ...
      itemBuilder: (ctx, i) {
        ...
        return GestureDetector(
          ...
          onTap: () async {
            ...
            // controller.textEditingController.close();
