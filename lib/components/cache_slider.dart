...
class CacheSlider extends StatefulWidget {
  final double value;
  ...
  final CacheSliderColors colors;
  ...
  const CacheSlider({
    ...
    this.min = 0.0,
    this.max = 1.0,
    this.colors = const CacheSliderColors(),
  });

  @override
  State<StatefulWidget> createState() {
    return _CacheSliderState();
  }
}

class _CacheSliderState extends State<CacheSlider> {
  bool dragging = false;
